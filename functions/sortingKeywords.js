...
function alphabetDesc(a, b) { return b.localeCompare(a); };

function binaryFound(key, arr){ return binarySearch(key, arr) != -1 }
...
sortKeys.duplicatesRemoved = function(arr, currentKeywords){
    ...
    return arr.filter(function(curr){ return !finder(curr)});;
}
